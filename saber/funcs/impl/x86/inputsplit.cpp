#include "saber/funcs/impl/x86/inputsplit.h"
...
SaberStatus InputSplit<X86, OpDtype>::create(const std::vector<Tensor<X86>*>& inputs,
                    std::vector<Tensor<X86>*>& outputs,
                    InputSplitParam<X86> &param,
                    Context<X86> &ctx) {
...
template <DataType OpDtype>
SaberStatus InputSplit<X86, OpDtype>::dispatch(\
...
DEFINE_OP_TEMPLATE(InputSplit, InputSplitParam, X86, AK_HALF);
DEFINE_OP_TEMPLATE(InputSplit, InputSplitParam, X86, AK_INT8);
} //namespace anakin
