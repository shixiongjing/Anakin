 ...
 */
template<typename Ttype, Precision Ptype>
class InputSplit : public Operator<Ttype, Ptype> {
public:
    ...
    friend class InputSplitHelper<Ttype, Ptype>;
};
 ...
 */
template<typename Ttype, Precision Ptype>
class InputSplitHelper : public OperatorHelper<Ttype, Ptype> {
